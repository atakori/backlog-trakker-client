import { FETCH_GAME_INFO, FETCH_GAME_SUMMARY, FETCH_GAME_GENRE_IDS, FETCH_CRITIC_SCORES, FETCH_USER_SCORES, FETCH_SIMILAR_GAME_IDS, CHECK_GAME_COLLECTION } from '../actions/types'
